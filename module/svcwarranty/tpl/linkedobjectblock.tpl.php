 ...
 * \ingroup warrantysvc
 * \brief   Template to render Warranty rows in Related Objects panel
 */
...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	print '<td class="linkedcol-date center">'.dol_print_date($objectlink->start_date, 'day').'</td>';
	...
	if (function_exists('svcwarranty_status_badge')) {
		...
		print dol_escape_htmltag($objectlink->status);
	}
	print '</td>';
